    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(180deg, rgba(0,0,0,.35) 0%, rgba(60,0,15,.45) 50%, rgba(0,0,0,.65) 100%)",
        }}
      />
      <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
        <div
          style={{
            ...
            width: "38%",
            background: "linear-gradient(90deg,transparent,rgba(255,255,255,.04),transparent)",
            animation: "silkMove 15s linear infinite",
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(212,175,55,.18) 0%, transparent 70%)",
          animation: "goldOrb 7s ease-in-out infinite",
      ...
      >
        <div style={{ animation: "fadeUp 1s cubic-bezier(.4,0,.2,1) .15s both" }}>
          <span className="ey" style={{ color: "rgba(212,175,55,0.95)" }}>
            Handwoven Heritage · Est. 2024
          </span>
        </div>
        <h1
          style={{
        ...
        >
          ...
          <Link to="/artisans" className="btn-outline-white">
            Meet the Artisans
          </Link>
        </div>
      </div>
      ...
      <div className="wrap">
        ...
        >
          <div className={`rv-l ${on ? "on" : ""}`} style={{ position: "relative" }}>
            ...
            <div
              style={{
                ...
                borderRadius: 22,
                overflow: "hidden",
                boxShadow: "0 40px 90px rgba(0,0,0,.18)",
              }}
            >
              <img
                src={IMG.loom}
            ...
            <div
              className="stat-pill"
              style={{ position: "absolute", bottom: -22, left: -16, zIndex: 2 }}
            >
              <div
                style={{
                  fontFamily: "'Cormorant Garamond',serif",
            ...
            >
              <path
                className={`thread-path ${sv ? "on" : ""}`}
                d="M8 88 Q 52 8, 92 88"
                stroke="currentColor"
                strokeWidth="1.5"
                fill="none"
              />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div className={`gd rv d3 ${on ? "on" : ""}`} />
            <p
              className={`rv d3 ${on ? "on" : ""}`}
              style={{ fontSize: T.body, lineHeight: 1.88, color: C.warmGrey, fontWeight: 400 }}
            >
              Our looms are not machines — they are extensions of the artisan&apos;s soul. Passed down
              through generations, the rhythm of the shuttle echoes the heartbeat of rural India.
            </p>
            <p
              className={`rv d4 ${on ? "on" : ""}`}
              style={{ fontSize: T.body, lineHeight: 1.88, color: C.warmGrey, fontWeight: 400 }}
            >
              We work directly with weavers in Bengal, Varanasi, and Odisha, preserving techniques
              that predate written history. When you wear a Neyge saree, you wear a legacy.
            </p>
            <div
              className={`rv d5 ${on ? "on" : ""}`}
            ...
            <div className={`rv d6 ${on ? "on" : ""}`}>
              <Link to="/about" className="link-gold">
                Read the full loom story <span style={{ fontSize: 16 }}>→</span>
              </Link>
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(to top, rgba(0,0,0,.75) 0%, rgba(0,0,0,.1) 45%, rgba(0,0,0,.35) 100%)",
        }}
      />
      <div
        style={{
      ...
      >
        <span className={`ey rv ${on ? "on" : ""}`} style={{ color: "rgba(212,175,55,.95)", marginBottom: 16 }}>
          Collection
        </span>
        <h3
          className={`rv d2 ${on ? "on" : ""}`}
        ...
        <div className={`rv d4 ${on ? "on" : ""}`}>
        <Link to={`/collections/${slug}`} className="col-btn">
  Explore Collection
</Link>
        </div>
      </div>
          ...
          <div className={`rv-l ${on ? "on" : ""}`} style={{ position: "relative" }}>
            <div
              style={{
                borderRadius: 24,
                overflow: "hidden",
                boxShadow: "0 48px 100px rgba(0,0,0,.2)",
                aspectRatio: "4/5",
                position: "relative",
              }}
            >
              <img
                ...
                style={{
                  ...
                  height: "100%",
                  objectFit: "cover",
                  animation: "crossA 15s ease-in-out infinite",
                }}
              />
              <img
                src={IMG.artisan2}
                ...
                style={{
                  ...
                  height: "100%",
                  objectFit: "cover",
                  animation: "crossB 15s ease-in-out infinite",
                }}
              />
            </div>
            <div
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <blockquote
              ...
              style={{
                ...
                color: "#3a1818",
                lineHeight: 1.78,
                borderLeft: `2.5px solid rgba(196,152,10,.4)`,
                paddingLeft: 22,
                margin: 0,
              }}
            >
              "I learned to weave from my mother when I was seven. The loom is like a third hand to me.
              Every saree I make carries a piece of my home — the smell of earth, the sound of peacocks,
              the warmth of the sun on fresh yarn."
            </blockquote>
            <p
              className={`rv d4 ${on ? "on" : ""}`}
              style={{ fontSize: T.body, lineHeight: 1.85, color: C.warmGrey, fontWeight: 400 }}
            >
              Radha is one of 43 master weavers we collaborate with in the villages of Murshidabad.
              Her family has been weaving silk for over 200 years.
            </p>
          </div>
        </div>
      </div>
...
function FeaturedSarees() {
  ...
  useEffect(() => {
    const loadFeaturedProducts = async () => {
      try {
        ...
        const mapped = (response?.data?.items || []).map(mapProductToSaree);
        ...
        setProducts((fallbackResponse?.data?.items || []).map(mapProductToSaree));
      } catch (error) {
  ...
  return (
    ...
    >
      <div className="wrap">
        <div className={`rv ${on ? "on" : ""}`} style={{ textAlign: "center", marginBottom: 64 }}>
          <span className="ey" style={{ display: "block", marginBottom: 16 }}>
            Curated Collection
          </span>
          <h2
            style={{
        ...
        {loading ? (
          <div style={{ textAlign: "center", color: C.warmGrey, fontSize: 16 }}>
  ...
  return (
    ...
    >
      <div className="wrap">
        <div
          className="grid-2"
          style={{ display: "grid", gridTemplateColumns: "5fr 7fr", gap: 72, alignItems: "center" }}
        >
          <div className={`rv-l ${on ? "on" : ""}`} style={{ position: "relative" }}>
            <div className="video-wrapper">
              <video
                ...
                <button className="play-btn" onClick={handlePlay} aria-label="Play video">
                  <div
                    style={{
                      ...
                      borderLeft: `22px solid ${C.maroon}`,
                      marginLeft: 5,
                    }}
                  />
                </button>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <p
              ...
              style={{ fontSize: T.body, lineHeight: 1.88, color: C.warmGrey, fontWeight: 400 }}
            >
              Not sure which saree tells your story? Book a one-on-one video session with our
              in-house styling experts.
            </p>
            <div className={`rv d4 ${on ? "on" : ""}`} style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              {["Draping guidance", "Fabric expertise", "Occasion styling", "Free of charge"].map((t) => (
            ...
            <div className={`rv d5 ${on ? "on" : ""}`} style={{ marginTop: 4 }}>
              <Link to="/video-shopping" className="btn-gold">
                ▶&nbsp; Book a Free Session
              </Link>
            </div>
          </div>
    ...
    >
      <div className="wrap">
        <div className={`rv ${on ? "on" : ""}`} style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p style={{ fontFamily: "'Jost'", fontSize: T.small, color: "#9a8070", letterSpacing: ".12em", fontWeight: 500 }}>
            @neyge.couture
          </p>
        </div>
      </div>
  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="ey" style={{ marginBottom: 22 }}>
            Begin Your Journey
          </span>
