...
/* ─────────────────────────────────────────
   ROOT — sticky bar
   Brand colours: cream #F5EAD9, crimson #8B0000, gold #C4980A
───────────────────────────────────────── */
.hd-root {
...
.hd-root.top      { background: rgba(245,234,217,.90); backdrop-filter: blur(14px); }
.hd-root.scrolled { background: rgba(245,234,217,.98); backdrop-filter: blur(22px);
                     box-shadow: 0 2px 20px rgba(139,0,0,.08); }
...
/* TOP STATE */
.hd-root.top .hd-logo-img {
  height: 64px;
}

/* SCROLLED STATE */
.hd-root.scrolled .hd-logo-img {
  height: 52px;
}
...
/* ─────────────────────────────────────────
   ...
   Brand colours used for the saree-border tile
───────────────────────────────────────── */
.hd-border {
...
.hd-border-shimmer {
  ...
  background: linear-gradient(90deg, transparent 0%, rgba(196,152,10,.45) 50%, transparent 100%);
  animation: hdShimmer 5.5s ease-in-out infinite;
  pointer-events: none;
}
 
/* ─────────────────────────────────────────
   DESKTOP NAV — Josefin Sans, crimson hover
───────────────────────────────────────── */
...
.hd-nav-link:hover { color: #8B0000; }
.hd-nav-link::after {
...
/* Eyebrow-style "new" tag */
.hd-nav-badge {
  display: inline-block; margin-left: 5px;
  padding: 2px 5px; background: #8B0000; color: #F5EAD9;
  font-size: 8px; letter-spacing: .12em; font-weight: 600; text-transform: uppercase;
  vertical-align: middle;
}
 
/* ─────────────────────────────────────────
   ICON BUTTONS — crimson badge
───────────────────────────────────────── */
...
.hd-icon-btn:hover { background: rgba(139,0,0,.08); transform: scale(1.08); }
...
/* ─────────────────────────────────────────
   MOBILE MENU — cream bg, crimson accents
───────────────────────────────────────── */
.hd-mobile {
  border-top: 1px solid rgba(139,0,0,.15);
  background: rgba(245,234,217,.99); backdrop-filter: blur(20px);
...
.hd-mobile-link {
  ...
  text-transform: uppercase; font-weight: 500;
  color: #4a3828; text-decoration: none;
  border-bottom: 1px solid rgba(139,0,0,.10);
  transition: color .2s, padding-left .2s;
}
.hd-mobile-link:last-child { border-bottom: none; }
.hd-mobile-link:hover { color: #8B0000; padding-left: 10px; }
 
/* ─────────────────────────────────────────
   SEARCH OVERLAY (optional future use)
───────────────────────────────────────── */
.hd-search-overlay {
  position: fixed; inset: 0; z-index: 100;
  background: rgba(245,234,217,.96); backdrop-filter: blur(20px);
  display: flex; align-items: center; justify-content: center;
}
`;
 
/* Butta-inspired tile — recoloured in brand crimson + gold */
const TILE_SVG = `
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="8.5" viewBox="0 0 32 8.5">
  ...
  <polygon points="8,2.2  10.2,4  8,5.8  5.8,4" fill="#8B0000" stroke="#C4980A" stroke-width="0.3" opacity="0.90"/>
  <polygon points="8,3   9.2,4  8,5   6.8,4" fill="#F5EAD9" opacity="0.30"/>
  ...
  <polygon points="24,0.8  28,4  24,7.2  20,4" fill="#8B0000" stroke="#C4980A" stroke-width="0.4" opacity="0.85"/>
  <polygon points="24,2.2  26.6,4  24,5.8  21.4,4" fill="#F5EAD9" opacity="0.28"/>
